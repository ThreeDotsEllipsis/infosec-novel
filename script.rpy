...
label cafe_trip:
    ...
    антивирусов дурацких."
    serg "Еле как потом его данные в модеусе восстановил, хотя все равно 
    ...
    den "Ден: Да ладно тебе. Пошутить уже и нельзя чтоли?"
    ...
    serg "Сергей: Ладно, нам пора, а то у нас коменданша-женщина серьезная. Может и не пустить 
