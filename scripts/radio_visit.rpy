...
label subjects:
    svet "На данный момент нужно сдавать Профильную математику, Русский язык и 
...
default menusetLife = set()
label questionsLife:
    if len(menusetLife) == 7:
        jump questions
    else:
        menu:
            set menusetLife
            ...
            "1. Спорт":
                ...
                svet "Наиболее популярные среди них: универсиада УрФУ, проект ИГРА 
                ...
                площадок на территории студгородка." 
                svet "В 2007 г. открылся новый спортивный комплекс 
            ...
            "2. Творчество":
                ...
                спортивным бальным танцам на Кубок УрФУ," 
                svet "рейтинговый турнир по акробатическому рок-н-
                ...
                коллектива, смотры художественной самодеятельности институтов УрФУ," 
                svet "дебют 
            ...
            "3. Студенческая наука":
                ...
                svet "машиностроение, металлургия, новые материалы и 
                ...
                библиотека (ЗНБ)." 
                svet "Она с каждым годом развивается, осваивает новые технологии, следует 
            ...
            "4. Международное сотрудничество":
                ...
                всю международную палитру Уральского федерального университета." 
                svet "В организации состоят 
                ...
                адаптацией первокурсников дальнего зарубежья." 
                svet "Команда buddy обеспечивает языковую и 
            ...
            "5. Волонтерство":
                ...
                svet "а также создание благоприятной среды, направленной на 
            ...
            "6. Лига КВН":
                ...
                обучающая и является отличной стартовой площадкой для начинающих команд."
                svet "Во-вторых, 
                ...
                jump questionsLife
            "7. Студенческий отряд":
                svet "Это объединение студенческой молодёжи, которое летом занимается совместной трудовой 
                деятельностью на выезде во время летних каникул." 
                svet "В течение учебного года отряд участвует в 
                творческой, спортивной и социальной активностях." 
                svet "Участие в деятельности студенческих 
                отрядов позволяет всесторонне развить личность попавшего в это движение. СО дают 
                возможность реализовать себя в различных сферах," 
                svet "начиная с творчества, спорта и заканчивая 
