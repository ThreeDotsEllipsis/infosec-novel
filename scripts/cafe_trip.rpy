label cafe_trip:
    ...
    Деревянные стулья и столики, гирлянды и растения на подоконниках придавали этому 
    место что-то невероятно притягательное." 
    "Олег сел за столик, его ноги гудели от долгой 
    прогулки и он был не прочь перекусить"
